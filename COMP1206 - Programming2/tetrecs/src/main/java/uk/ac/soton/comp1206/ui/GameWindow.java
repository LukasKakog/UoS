...
public class GameWindow {
    ...
    /**
     * Display ECS intro before the main menu.
     */
    ...
    /**
     * Display Lobby when waiting for a multiplayer game to start
     */
    public void startMultiplayerLobby() { loadScene(new LobbyScene(this)); }

    /**
     * Display score screen post game
     * @param game
     */
