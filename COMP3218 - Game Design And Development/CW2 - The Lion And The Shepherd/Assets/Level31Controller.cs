...
public class Level31Controller : MonoBehaviour, LevelController {
    ...
    public void StartSecondCutScene() {
        ...
        playerController.SetPlayerPositionAndRotation(new Vector3(-0.62f, 0.649f, -1.21f), Quaternion.Euler(90f, 36f, 0f));
        lionController.transform.position = new Vector3(0f, 0.51f, 0.64f);
