package students;/* To use students.Toolbox.java, copy and paste this code into a file called students.Toolbox.java
 ...
 * Only one instance of the students.Toolbox class should be created.
...
public class Toolbox {
   ...
   * The values will be consumed by students.Toolbox instances instead of prompting the user for input or querying a random number generator.
